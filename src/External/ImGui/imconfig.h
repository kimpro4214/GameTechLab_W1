...
#define IMGUI_DISABLE_DEMO_WINDOWS                          // The game does not expose Dear ImGui demo windows.
...
#define IMGUI_DISABLE_DEFAULT_SHELL_FUNCTIONS               // The game never opens external files or URLs from ImGui.
